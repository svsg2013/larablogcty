        ...
        <div class="col-lg-8 blog__content mb-30">
            ...
            <article class="entry post-list">
                <div class="entry__img-holder post-list__img-holder">
                    <a href="single-post.html">
                        <div class="thumb-container thumb-75">
                            <img data-src="img/blog/list_post_img_1.jpg" src="img/empty.png" class="entry__img lazyload"
                                 alt="">
                        </div>
                    </a>
                </div>
                ...
                <div class="entry__body post-list__body">
                    ...
                    <div class="entry__excerpt">
                        <p>Point of Sale hardware, the till at a shop check out, has become very complex over the past
                            ten years. Modern POS hardware includes the cash till, bar-code readers...</p>
                    </div>
                </div>
            </article>
            ...
            <article class="entry post-list">
                <div class="entry__img-holder post-list__img-holder">
                    <a href="single-post.html">
                        <div class="thumb-container thumb-75">
                            <img data-src="img/blog/list_post_img_2.jpg" src="img/empty.png" class="entry__img lazyload"
                                 alt="">
                        </div>
                    </a>
                </div>
            ...
            <article class="entry post-list">
                <div class="entry__img-holder post-list__img-holder">
                    <a href="single-post.html">
                        <div class="thumb-container thumb-75">
                            <img data-src="img/blog/list_post_img_3.jpg" src="img/empty.png" class="entry__img lazyload"
                                 alt="">
                        </div>
                    </a>
                </div>
                ...
                <div class="entry__body post-list__body">
                    <div class="entry__header">
                        ...
                        <h2 class="entry__title">
                            <a href="single-post.html">This Is the Burberry Bag Every Fashion Girl Wanted 15 Years
                                Ago</a>
                        </h2>
                        <ul class="entry__meta">
                            <li class="entry__meta-author">
